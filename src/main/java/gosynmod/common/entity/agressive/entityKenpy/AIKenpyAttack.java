...
public class AIKenpyAttack extends AnimationAI<EntityKenpy> {
	...
	public AIKenpyAttack(EntityKenpy kenpy, Animation animation, double speedIn, boolean useLongMemory) {
		super(kenpy);
		setMutexBits(4);
		this.kenpy = kenpy;
		this.animation = animation;
		this.attacker = kenpy;
		this.world = kenpy.world;
	...
	protected void checkAndPerformAttack(EntityLivingBase p_190102_1_, double p_190102_2_) {
		...
		if (p_190102_2_ <= d0 && this.attackTick <= 0 ) {
			AnimationHandler.INSTANCE.sendAnimationMessage(kenpy, kenpy.ANIMATION_ATTACK);
			this.attackTick = 20;
